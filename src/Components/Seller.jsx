...
function Retailer(props) {
  ...
  return (
    <div className='mt-7'>
      <h1 className='text-3xl font-bold pl-4 leading-31'>Register with CropVenture as an Associate Retailer</h1>
...
<form className='w-4/5'>
  <div className="space-y-12">
    <div className="border-b border-gray-900/10 pb-12">
      ...
      <p className="mt-1 text-sm leading-6 text-gray-600">Please enter the legitimite details associated with your business.</p>
      <div className="mt-10 space-y-10">

      <div className="sm:col-span-4">
          <label htmlFor="bname" className="block text-sm font-medium leading-6 text-gray-900">Registered Business Name</label>
          <div className="mt-2">
            <input id="bname" name="bname" type="text" autoComplete="given-name" className="block px-2 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:border focus:outline-none focus:border-green-400 sm:text-sm sm:leading-6"/>
          </div>
        </div>

        <div className="sm:col-span-4">
          <label htmlFor="gstin" className="block text-sm font-medium leading-6 text-gray-900">GSTIN(/GST Number)</label>
          <div className="mt-2">
            <input id="gstin" name="gstin" type="text" autoComplete="gstin" className="block px-2 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:border focus:outline-none focus:border-green-400 sm:text-sm sm:leading-6"/>
          </div>
        </div>
        ...
        <div className="sm:col-span-4">
          ...
          <div className="mt-2">
            <input id="pan" name="pan" type="text" autoComplete="pan" className="block px-2 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:border focus:outline-none focus:border-green-400 sm:text-sm sm:leading-6"/>
          </div>
        </div>
    ...
    <div className=" pb-12">
      ...
      <p className="mt-1 text-sm leading-6 text-gray-600">Please enter the bank account details linked to your business.</p>
      <div className="mt-10 space-y-10">
    ...
    <div className="max-w-6xl mx-auto sm:px-6 ">
        ...
        <div className="flow-root mt-12 sm:mt-16">
            <div className="divide-y divide-gray--200 -my-9">
                <div className="py-9">
                    <p className="text-xl font-semibold text-black">Why become an associated retailer with CropVenture?</p>
                    <p className="mt-3 text-base text-gray-600">We supply high quality goods from state of the art storage facilities as reasonable rates. Retailers get endless variety of goods at the same place</p>
                </div>

                <div className="py-9">
                    <p className="text-xl font-semibold text-black">What benefits does an associated retailer get?</p>
                    <ul className="mt-3 text-base text-gray-600 list-disc">
                    <li>High quality of goods guaranteed.</li>
                    <li>Super fast on-time deliveries assured.</li>
                    <li>Extensive variety of goods avaialable for purchase.</li>
                    <li>All procedures are executed through legal contracts to ensure credibility.</li>
                    </ul>
                </div>

                <div className="py-9">
                    <p className="text-xl font-semibold text-black">How are payment transactions executed?</p>
